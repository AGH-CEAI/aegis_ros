...
class RobotReadServiceImpl final : public proto_aegis_grpc::v1::RobotReadService::Service {
 public:
  ...
  grpc::Status GetJointStates(grpc::ServerContext* context,
                              const google::protobuf::Empty* request,
                              proto_aegis_grpc::v1::JointState* response) override;

  grpc::Status GetCameraSceneImage(grpc::ServerContext* context,
                                   const google::protobuf::Empty* request,
                                   proto_aegis_grpc::v1::Image* response) override;

  grpc::Status GetCameraRightImage(grpc::ServerContext* context,
                                   const google::protobuf::Empty* request,
                                   proto_aegis_grpc::v1::Image* response) override;

  grpc::Status GetCameraLeftImage(grpc::ServerContext* context,
                                  const google::protobuf::Empty* request,
                                  proto_aegis_grpc::v1::Image* response) override;
  ...
  grpc::Status GetRobotVision(grpc::ServerContext* context,
                              const google::protobuf::Empty* request,
                              proto_aegis_grpc::v1::RobotVision* response) override;
