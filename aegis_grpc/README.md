...
| Name              | Desc                                                            | Impl. | Type     | gRPC Def                                                                               | ROS Def                                                                                                                                    |
| ----------------- | --------------------------------------------------------------- | ----------- | -------- | -------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| GripperCommand    | Set the gripper width.                                          | ❌           | `action` | [`aegis_grpc.proto.v1.control_msgs.GripperCommand`](./proto/v1/control_msgs.proto)     | [`control_msgs/action/GripperCommand`](https://github.com/ros-controls/control_msgs/blob/humble/control_msgs/action/GripperCommand.action) |
...
| MoveToPoseTarget  | Plan & execute the MoveIt2 trajectory to a given pose target.   | ❌           | `action` | [`aegis_grpc.proto.v1.moveit_facade.MoveToPoseTarget`](./proto/v1/control_msgs.proto)  | -                                                                                                                                          |
| MoveToJointTarget | Plan & execute the MoveIt2 trajectory to a given joints target. | ❌           | `action` | [`aegis_grpc.proto.v1.moveit_facade.MoveToJointTarget`](./proto/v1/control_msgs.proto) | -                                                                                                                                          |
...
| -------------------------------------------------------------------------------------- | -------- | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| [`aegis_grpc.proto.v1.control_msgs.GripperCommand`](./proto/v1/control_msgs.proto)     | `action` | GripperCommand    | [`control_msgs/action/GripperCommand`](https://github.com/ros-controls/control_msgs/blob/humble/control_msgs/action/GripperCommand.action) |
| [`aegis_grpc.proto.v1.control_msgs.GripperStatus`](./proto/v1/control_msgs.proto)      | `msg`    | GripperStatus     | -                                                                                                                                          |
...
| [`aegis_grpc.proto.v1.moveit_facade.MoveToPoseTarget`](./proto/v1/control_msgs.proto)  | `action` | MoveToPoseTarget  | -                                                                                                                                          |
| [`aegis_grpc.proto.v1.moveit_facade.MoveToJointTarget`](./proto/v1/control_msgs.proto) | `action` | MoveToJointTarget | -                                                                                                                                          |
