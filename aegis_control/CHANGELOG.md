...
* [PR-129](https://github.com/AGH-CEAI/aegis_ros/pull/129) - Added `wled_service.launch.py` launch description
* [PR-129](https://github.com/AGH-CEAI/aegis_ros/pull/129) - Added `scenes.yaml` to `config/wled` folder
